...
**Also note:** For the moment, the app throws very ugly and uninformative errors if you enter the wrong combination of inputs (e.g., have the CSV file option checked, but upload an XLSX file). I'll be making these errors more informative as I update the app. 

**Lastly, if you encounter ANY errors or have some suggestions, please submit an issue on the <a href="https://github.com/kamermanpr/painblogr-startr/issues" target="_blank">GitHib repo</a>.**
...
- See examples of the data structure  <a href="https://i.imgur.com/hiIlagp.png" target="_blank">here</a>
...
- See examples of the data structure <a href="https://i.imgur.com/s9IxECNl.png" target="_blank">here</a>
...
- See examples of the data structure  <a href="https://i.imgur.com/vA5VF89l.png" target="_blank">here</a>
...
- Missing data pairs will be removed.  
- See examples of the data structure  <a href="https://i.imgur.com/JtYMuj1.png" target="_blank">here</a> 
...
- Missing data pairs will be removed.  
- See examples of the data structure  <a href="https://i.imgur.com/Cm7QNHVl.png" target="_blank">here</a>
